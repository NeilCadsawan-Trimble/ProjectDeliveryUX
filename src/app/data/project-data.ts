...
export const PROJECT_DATA: Record<number, ProjectDashboardData> = {
  1: {
    ...
    summaryStats: [
      ...
      { label: 'Due Date', value: 'Nov 30', subtext: '102 days remaining', subtextClass: 'text-foreground-60' },
    ],
    milestones: [
    ...
    tasks: [
      { id: 1, title: 'Complete curtain wall installation on floors 3-5', assigneeInitials: 'SC', assignee: 'Sarah Chen', priority: 'medium', dueDate: 'Aug 22', status: 'In Progress' },
      { id: 2, title: 'Complete elevator shaft fire testing on floors 1-4', assigneeInitials: 'PN', assignee: 'Priya Nair', priority: 'medium', dueDate: 'Aug 21', status: 'In Progress' },
      { id: 3, title: 'Coordinate HVAC duct routing with electrical conduit', assigneeInitials: 'MO', assignee: 'Mike Osei', priority: 'medium', dueDate: 'Aug 25', status: 'To Do' },
      { id: 4, title: 'Safety audit for scaffolding on west elevation', assigneeInitials: 'JC', assignee: 'James Carter', priority: 'low', dueDate: 'Aug 24', status: 'To Do' },
      { id: 5, title: 'Submit revised elevator shaft drawings to city', assigneeInitials: 'LB', assignee: 'Lena Brooks', priority: 'low', dueDate: 'Aug 27', status: 'To Do' },
      { id: 6, title: 'Start Level 3 punch list for elevator lobbies', assigneeInitials: 'TE', assignee: 'Tom Evans', priority: 'low', dueDate: 'Sep 2', status: 'To Do' },
    ],
    risks: [
    ...
    latestDrawing: { id: 1, name: 'Server Room - Floor 3 Layout', type: 'server-room', version: 'v3.2', isLatest: true, updatedBy: 'Mike Osei', updatedAt: 'Aug 18, 2026', revisionCount: 8, fileSize: '4.2 MB' },
    budgetUsed: '$544K',
    budgetTotal: '$800K',
    budgetPct: 68,
    budgetBreakdown: [
  ...
  2: {
    ...
    summaryStats: [
      ...
      { label: 'Due Date', value: 'Apr 30, 2027', subtext: '253 days remaining', subtextClass: 'text-foreground-60' },
    ],
    milestones: [
    ...
    tasks: [
      { id: 1, title: 'Pour concrete deck for Level 5 east wing', assigneeInitials: 'JC', assignee: 'James Carter', priority: 'medium', dueDate: 'Aug 22', status: 'In Progress' },
      { id: 2, title: 'Install window frames for units 301-320', assigneeInitials: 'RK', assignee: 'Rachel Kim', priority: 'medium', dueDate: 'Aug 25', status: 'In Progress' },
      { id: 3, title: 'Resolve waterproofing deficiency at parking level', assigneeInitials: 'DL', assignee: 'David Lin', priority: 'high', dueDate: 'Aug 19', status: 'In Progress' },
      { id: 4, title: 'Run plumbing risers for floors 4-6', assigneeInitials: 'AW', assignee: 'Amy Wu', priority: 'medium', dueDate: 'Aug 28', status: 'To Do' },
      { id: 5, title: 'Fire stopping inspection for floor penetrations', assigneeInitials: 'JC', assignee: 'James Carter', priority: 'low', dueDate: 'Sep 2', status: 'To Do' },
      { id: 6, title: 'Balcony railing mock-up approval from architect', assigneeInitials: 'NP', assignee: 'Nick Park', priority: 'low', dueDate: 'Sep 4', status: 'To Do' },
    ],
    risks: [
    ...
    latestDrawing: { id: 1, name: 'App Navigation Flow v2', type: 'architecture', version: 'v2.4', isLatest: true, updatedBy: 'Rachel Kim', updatedAt: 'Aug 15, 2026', revisionCount: 12, fileSize: '2.8 MB' },
    budgetUsed: '$246K',
    budgetTotal: '$300K',
    budgetPct: 82,
    budgetBreakdown: [
  ...
  3: {
    ...
    summaryStats: [
      ...
      { label: 'Due Date', value: 'Dec 18, 2026', subtext: '120 days remaining', subtextClass: 'text-destructive font-medium' },
    ],
    milestones: [
      ...
      { id: 4, name: 'Concourse & Canopy Steel', dueDate: 'Jul 31, 2026', status: 'overdue', progress: 65 },
      { id: 5, name: 'Track & Signal Installation', dueDate: 'Oct 15, 2026', status: 'in-progress', progress: 40 },
      { id: 6, name: 'Systems Testing & Revenue Service', dueDate: 'Dec 18, 2026', status: 'upcoming', progress: 0 },
    ],
    tasks: [
      { id: 1, title: 'Resolve RFI backlog on canopy steel connections (14 open)', assigneeInitials: 'PN', assignee: 'Priya Nair', priority: 'high', dueDate: 'Aug 18', status: 'In Progress' },
      { id: 2, title: 'Complete signal conduit routing for platform 2', assigneeInitials: 'KT', assignee: 'Karen Torres', priority: 'medium', dueDate: 'Aug 21', status: 'In Progress' },
      { id: 3, title: 'Escalate concrete supply delay with vendor', assigneeInitials: 'PN', assignee: 'Priya Nair', priority: 'medium', dueDate: 'Aug 19', status: 'In Progress' },
      { id: 4, title: 'Submit revised ADA compliance drawings to transit authority', assigneeInitials: 'RM', assignee: 'Rita Moreno', priority: 'medium', dueDate: 'Aug 26', status: 'To Do' },
      { id: 5, title: 'Reconcile as-built survey with design elevations', assigneeInitials: 'BW', assignee: 'Brian Walsh', priority: 'low', dueDate: 'Aug 25', status: 'To Do' },
      { id: 6, title: 'Coordinate track outage windows with transit operations', assigneeInitials: 'PN', assignee: 'Priya Nair', priority: 'low', dueDate: 'Sep 2', status: 'To Do' },
    ],
    risks: [
    ...
    latestDrawing: { id: 1, name: 'ERP Integration Architecture', type: 'architecture', version: 'v4.1', isLatest: true, updatedBy: 'Tom Evans', updatedAt: 'Aug 12, 2026', revisionCount: 15, fileSize: '6.1 MB' },
    budgetUsed: '$855K',
    budgetTotal: '$900K',
    budgetPct: 95,
    budgetBreakdown: [
  ...
  4: {
    ...
    summaryStats: [
      ...
      { label: 'Due Date', value: 'Aug 15, 2027', subtext: '360 days remaining', subtextClass: 'text-foreground-60' },
    ],
    milestones: [
    ...
    tasks: [
      { id: 1, title: 'Complete steel erection for surgical wing', assigneeInitials: 'TE', assignee: 'Tom Evans', priority: 'medium', dueDate: 'Aug 22', status: 'In Progress' },
      { id: 2, title: 'Coordinate medical gas piping layout with equipment vendor', assigneeInitials: 'AJ', assignee: 'Anita Joshi', priority: 'medium', dueDate: 'Aug 27', status: 'To Do' },
      { id: 3, title: 'Inspect fire-rated wall assemblies on Level 2', assigneeInitials: 'MO', assignee: 'Mike Osei', priority: 'medium', dueDate: 'Aug 29', status: 'To Do' },
      { id: 4, title: 'Review cost estimate for radiology shielding change order', assigneeInitials: 'CH', assignee: 'Chris Hall', priority: 'medium', dueDate: 'Sep 2', status: 'To Do' },
      { id: 5, title: 'Process subcontractor pay application for mechanical work', assigneeInitials: 'SP', assignee: 'Sara Park', priority: 'low', dueDate: 'Sep 3', status: 'To Do' },
      { id: 6, title: 'Update BIM model with as-built structural changes', assigneeInitials: 'TE', assignee: 'Tom Evans', priority: 'low', dueDate: 'Sep 4', status: 'To Do' },
    ],
    risks: [
    ...
    latestDrawing: { id: 1, name: 'Data Pipeline Architecture', type: 'architecture', version: 'v2.0', isLatest: true, updatedBy: 'Tom Evans', updatedAt: 'Aug 14, 2026', revisionCount: 6, fileSize: '3.5 MB' },
    budgetUsed: '$150K',
    budgetTotal: '$500K',
    budgetPct: 30,
    budgetBreakdown: [
  ...
  5: {
    ...
    summaryStats: [
      ...
      { label: 'Due Date', value: 'Mar 15, 2028', subtext: '573 days remaining', subtextClass: 'text-foreground-60' },
    ],
    milestones: [
      { id: 1, name: 'Demolition & Abatement', dueDate: 'Feb 10, 2026', status: 'completed', progress: 100 },
      { id: 2, name: 'Structural Reinforcement & New Foundations', dueDate: 'Sep 30, 2026', status: 'in-progress', progress: 75 },
    ...
    tasks: [
      { id: 1, title: 'Finalize structural engineering for anchor store entry', assigneeInitials: 'LB', assignee: 'Lena Brooks', priority: 'medium', dueDate: 'Aug 21', status: 'In Progress' },
      { id: 2, title: 'Prepare cost estimate for food court mechanical scope', assigneeInitials: 'NP', assignee: 'Nick Park', priority: 'medium', dueDate: 'Aug 25', status: 'In Progress' },
      { id: 3, title: 'Review storefront elevation drawings with architect', assigneeInitials: 'RK', assignee: 'Rachel Kim', priority: 'low', dueDate: 'Aug 28', status: 'To Do' },
      { id: 4, title: 'Procure long-lead items for escalator installation', assigneeInitials: 'DL', assignee: 'David Lin', priority: 'medium', dueDate: 'Sep 2', status: 'To Do' },
      { id: 5, title: 'Submit fire protection shop drawings for review', assigneeInitials: 'RK', assignee: 'Rachel Kim', priority: 'low', dueDate: 'Sep 4', status: 'To Do' },
    ],
    risks: [
    ...
    latestDrawing: { id: 1, name: 'Portal Sitemap & Wireframes', type: 'architecture', version: 'v1.2', isLatest: true, updatedBy: 'Rachel Kim', updatedAt: 'Jul 28, 2026', revisionCount: 4, fileSize: '1.8 MB' },
    budgetUsed: '$24K',
    budgetTotal: '$350K',
    budgetPct: 8,
    budgetBreakdown: [
  ...
  6: {
    ...
    summaryStats: [
      ...
      { label: 'Due Date', value: 'Nov 20', subtext: '92 days remaining', subtextClass: 'text-foreground-60' },
    ],
    milestones: [
      ...
      { id: 5, name: 'New Deck Pour & Barrier Rails', dueDate: 'Oct 15, 2026', status: 'in-progress', progress: 85 },
      { id: 6, name: 'Final Inspection & Traffic Reopening', dueDate: 'Nov 20, 2026', status: 'in-progress', progress: 50 },
    ],
    tasks: [
      { id: 1, title: 'Complete bridge deck concrete pour for spans 3-4', assigneeInitials: 'MO', assignee: 'Mike Osei', priority: 'high', dueDate: 'Aug 22', status: 'In Progress' },
      { id: 2, title: 'Install barrier rail clips and joints on spans 1-2', assigneeInitials: 'JC', assignee: 'James Carter', priority: 'medium', dueDate: 'Aug 21', status: 'In Progress' },
      { id: 3, title: 'Compile environmental compliance documentation for DOT', assigneeInitials: 'AW', assignee: 'Amy Wu', priority: 'medium', dueDate: 'Aug 25', status: 'In Progress' },
      { id: 4, title: 'Install permanent barrier rail and striping', assigneeInitials: 'LB', assignee: 'Lena Brooks', priority: 'medium', dueDate: 'Aug 28', status: 'To Do' },
      { id: 5, title: 'Coordinate traffic lane reopening with DOT', assigneeInitials: 'MO', assignee: 'Mike Osei', priority: 'low', dueDate: 'Sep 3', status: 'To Do' },
    ],
    risks: [
    ...
    latestDrawing: { id: 1, name: 'Network Security Topology', type: 'network', version: 'v2.3', isLatest: true, updatedBy: 'Mike Osei', updatedAt: 'Aug 19, 2026', revisionCount: 9, fileSize: '5.4 MB' },
    budgetUsed: '$108K',
    budgetTotal: '$150K',
    budgetPct: 72,
    budgetBreakdown: [
  ...
  7: {
    ...
    summaryStats: [
      ...
      { label: 'Due Date', value: 'Jan 15, 2027', subtext: '148 days remaining', subtextClass: 'text-warning font-medium' },
    ],
    milestones: [
      ...
      { id: 3, name: 'Wood-Frame Superstructure (Floors 1-4)', dueDate: 'Sep 15, 2026', status: 'in-progress', progress: 55 },
    ...
    tasks: [
      { id: 1, title: 'Resolve framing deficiency on Building B stairwell', assigneeInitials: 'SC', assignee: 'Sarah Chen', priority: 'high', dueDate: 'Aug 19', status: 'In Progress' },
      { id: 2, title: 'Install roof trusses for Building A north wing', assigneeInitials: 'DL', assignee: 'David Lin', priority: 'medium', dueDate: 'Aug 22', status: 'In Progress' },
      { id: 3, title: 'Fix stormwater drainage conflict at courtyard', assigneeInitials: 'SC', assignee: 'Sarah Chen', priority: 'medium', dueDate: 'Aug 18', status: 'In Progress' },
      { id: 4, title: 'Submit siding material substitution for owner approval', assigneeInitials: 'SP', assignee: 'Sara Park', priority: 'low', dueDate: 'Aug 28', status: 'To Do' },
      { id: 5, title: 'Pressure test domestic water lines for floors 1-2', assigneeInitials: 'DL', assignee: 'David Lin', priority: 'medium', dueDate: 'Aug 26', status: 'To Do' },
    ],
    risks: [
    ...
    latestDrawing: { id: 1, name: 'API Gateway Architecture', type: 'architecture', version: 'v3.0', isLatest: true, updatedBy: 'Sarah Chen', updatedAt: 'Aug 16, 2026', revisionCount: 11, fileSize: '3.9 MB' },
    budgetUsed: '$110K',
    budgetTotal: '$200K',
    budgetPct: 55,
    budgetBreakdown: [
  ...
  8: {
    ...
    summaryStats: [
      ...
      { label: 'Due Date', value: 'Feb 28, 2028', subtext: '557 days remaining', subtextClass: 'text-foreground-60' },
    ],
    milestones: [
      { id: 1, name: 'Site Grading & Stormwater Management', dueDate: 'Feb 1, 2026', status: 'completed', progress: 100 },
      { id: 2, name: 'Foundation & Slab-on-Grade', dueDate: 'Sep 15, 2026', status: 'in-progress', progress: 80 },
    ...
    tasks: [
      { id: 1, title: 'Complete slab-on-grade pour for warehouse bay 1', assigneeInitials: 'PN', assignee: 'Priya Nair', priority: 'medium', dueDate: 'Aug 22', status: 'In Progress' },
      { id: 2, title: 'Erect steel columns and purlins for bays 2-4', assigneeInitials: 'CH', assignee: 'Chris Hall', priority: 'medium', dueDate: 'Aug 27', status: 'In Progress' },
      { id: 3, title: 'Install underground fire main and hydrant connections', assigneeInitials: 'AJ', assignee: 'Anita Joshi', priority: 'medium', dueDate: 'Aug 29', status: 'To Do' },
      { id: 4, title: 'Verify compaction test results for truck apron subbase', assigneeInitials: 'PN', assignee: 'Priya Nair', priority: 'medium', dueDate: 'Sep 2', status: 'To Do' },
      { id: 5, title: 'Run conduit for 480V electrical distribution panels', assigneeInitials: 'TE', assignee: 'Tom Evans', priority: 'low', dueDate: 'Sep 4', status: 'To Do' },
      { id: 6, title: 'Review PEMB shop drawings for bays 2-4', assigneeInitials: 'LB', assignee: 'Lena Brooks', priority: 'low', dueDate: 'Sep 3', status: 'To Do' },
    ],
    risks: [
    ...
    latestDrawing: { id: 1, name: 'Warehouse Floor Plan', type: 'architecture', version: 'v1.5', isLatest: true, updatedBy: 'Priya Nair', updatedAt: 'Aug 10, 2026', revisionCount: 5, fileSize: '2.9 MB' },
    budgetUsed: '$90K',
    budgetTotal: '$500K',
    budgetPct: 18,
    budgetBreakdown: [
