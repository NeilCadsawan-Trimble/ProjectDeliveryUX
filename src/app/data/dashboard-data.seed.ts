...
export const PROJECTS: Project[] = [
  ...
  { id: 6, slug: 'metro-bridge-rehabilitation', name: 'Metro Bridge Rehabilitation', client: 'Trimble Internal', ownerInitials: 'BH', owner: 'Bert Humphries', status: 'On Track', dueDate: 'Jun 15, 2026', progress: 88, budgetPct: 72, budgetUsed: '$108K', budgetTotal: '$150K', latestDrawingName: 'Bridge Deck Cross Section', latestDrawingVersion: 'v2.3', city: 'Tacoma', state: 'WA' },
...
export const ACTIVITIES: ActivityItem[] = [
  { id: 1, actorInitials: 'SC', text: 'updated Riverside Office Phase 3 estimate — revised scope adds $40K', timeAgo: '18 min ago', icon: 'edit', iconColor: 'text-primary', projectId: 1 },
  { id: 2, actorInitials: 'PN', text: 'flagged Downtown Transit Hub budget at 95% — escalation required', timeAgo: '1 hr ago', icon: 'warning', iconColor: 'text-warning', projectId: 3 },
  ...
  { id: 4, actorInitials: 'MO', text: 'Metro Bridge checkpoint "Deck Assessment" marked complete', timeAgo: '3 hrs ago', icon: 'check_circle', iconColor: 'text-success', projectId: 6 },
  { id: 5, actorInitials: 'JC', text: 'Harbor View Condominiums moved to At Risk — material delivery delay', timeAgo: 'Yesterday', icon: 'warning', iconColor: 'text-warning', projectId: 2 },
...
export const ATTENTION_ITEMS = [
  { id: 1, title: 'Transit Hub budget at 95%', subtitle: '$45K remaining -- change request pending', dotClass: 'bg-destructive' },
  ...
  { id: 3, title: 'EST-2026-047 overdue', subtitle: 'Awaiting approval since Feb 25', dotClass: 'bg-warning' },
...
export const RFIS_SEED: Rfi[] = [
  ...
  { id: '6', number: 'RFI-006', subject: 'Bearing capacity at pier locations', question: 'Should the load test program cover all pier locations or only those in the suspect geologic zone, and what acceptance criteria will be used for load test results?', askedBy: 'Angela Torres', askedOn: 'Feb 14, 2026', project: 'Metro Bridge Rehabilitation', assignee: 'Mike Osei', status: 'open', dueDate: 'Mar 22, 2026' },
...
export const SUBMITTALS_SEED: Submittal[] = [
  ...
  { id: '2', number: 'SUB-002', subject: 'Kitchen cabinet specifications', project: 'Harbor View Condominiums', assignee: 'James Carter', status: 'open', dueDate: 'Mar 22, 2026' },
  ...
  { id: '6', number: 'SUB-006', subject: 'Bridge bearing pad samples', project: 'Metro Bridge Rehabilitation', assignee: 'Mike Osei', status: 'overdue', dueDate: 'Mar 22, 2026' },
  ...
  { id: '11', number: 'SUB-011', subject: 'Roof membrane product data', project: 'Harbor View Condominiums', assignee: 'James Carter', status: 'overdue', dueDate: 'Mar 2, 2026' },
  ...
  { id: '14', number: 'SUB-014', subject: 'Epoxy floor coating samples', project: 'Industrial Park Warehouse', assignee: 'Priya Nair', status: 'open', dueDate: 'Apr 10' },
...
export const CONTRACTS: Contract[] = [
  ...
  { id: 'SC-2026-006', project: 'Metro Bridge Rehabilitation', projectId: 6, contractType: 'subcontract', title: 'Concrete Repair -- BridgeTech Concrete', vendor: 'BridgeTech Concrete', originalValue: 55000, revisedValue: 74000, status: 'active', startDate: 'Dec 10, 2025', endDate: 'Jun 15, 2026', scope: 'Deck scarification, epoxy injection, and concrete overlay', retainage: 5, linkedChangeOrderIds: ['SCO-006'] },
...
export const PROJECT_ATTENTION_ITEMS: ProjectAttentionItem[] = [
  { id: 'pa-1', projectId: 1, title: 'Cutover window approaching', subtitle: 'Production migration Wave 2 starts in 3 days -- team readiness check needed', severity: 'info', category: 'schedule' },
  { id: 'pa-2', projectId: 1, title: 'RFI-013 pending review', subtitle: 'Emergency generator placement -- response expected next week', severity: 'info', category: 'rfi' },
  { id: 'pa-3', projectId: 2, title: 'Budget at 82%', subtitle: 'Only $54K remaining with 55% of work left', severity: 'warning', category: 'budget' },
  { id: 'pa-4', projectId: 2, title: 'RFI-002 overdue', subtitle: 'ADA compliance for common areas -- 27 days past due', severity: 'warning', category: 'rfi' },
  { id: 'pa-5', projectId: 2, title: 'SUB-011 overdue', subtitle: 'Roof membrane product data -- holding up waterproofing', severity: 'info', category: 'submittal' },
  ...
  { id: 'pa-7', projectId: 3, title: 'UAT defect backlog growing', subtitle: '14 open defects -- vendor escalation in progress', severity: 'warning', category: 'quality' },
  ...
  { id: 'pa-9', projectId: 4, title: 'Fire marshal inspection overdue', subtitle: 'Zone B approval needed before level 3 work can start -- 5 days past scheduled date', severity: 'warning', category: 'inspection' },
  ...
  { id: 'pa-11', projectId: 7, title: 'Foundation waterproofing delayed', subtitle: 'Wood framing deficiency blocking Building B progress -- recovery plan in place', severity: 'warning', category: 'schedule' },
  ...
  { id: 'pa-15', projectId: 7, title: 'Concrete pour quality hold', subtitle: 'Building B slab core test below 3,500 PSI -- re-pour under evaluation', severity: 'warning', category: 'quality' },
...
export const PUNCH_LIST_ITEMS: PunchListItem[] = [
  { id: 'PL-001', projectId: 1, project: 'Riverside Office Complex', location: 'Level 2 - East Wing', description: 'Ceiling grid misaligned at column C-4', assignee: 'Pacific Drywall', status: 'open', priority: 'low', createdDate: 'Mar 24, 2026' },
  { id: 'PL-002', projectId: 1, project: 'Riverside Office Complex', location: 'Level 1 - Lobby', description: 'Floor tile grout color does not match approved sample', assignee: 'Metro Paving', status: 'open', priority: 'medium', createdDate: 'Mar 22, 2026' },
  { id: 'PL-003', projectId: 1, project: 'Riverside Office Complex', location: 'Roof', description: 'HVAC condensate drain not sloped to roof drain', assignee: 'Summit HVAC', status: 'in-progress', priority: 'medium', createdDate: 'Mar 20, 2026' },
  { id: 'PL-004', projectId: 6, project: 'Metro Bridge Rehabilitation', location: 'Span 2 - Bearing', description: 'Bearing pad shimming incomplete at south abutment', assignee: 'Foundation Specialists', status: 'in-progress', priority: 'medium', createdDate: 'Mar 18, 2026' },
  { id: 'PL-005', projectId: 6, project: 'Metro Bridge Rehabilitation', location: 'Deck surface', description: 'Expansion joint seal has 3mm gap exceeding tolerance', assignee: 'Atlas Roofing Co', status: 'open', priority: 'low', createdDate: 'Mar 23, 2026' },
  ...
  { id: 'PL-008', projectId: 2, project: 'Harbor View Condominiums', location: 'Building A - Unit 305', description: 'Cabinet door alignment off by 3mm on upper run', assignee: 'Pacific Drywall', status: 'open', priority: 'low', createdDate: 'Mar 20, 2026' },
  { id: 'PL-009', projectId: 2, project: 'Harbor View Condominiums', location: 'Building B - Exterior', description: 'Siding lap joint gap at NE corner exceeds spec', assignee: 'Atlas Roofing Co', status: 'in-progress', priority: 'medium', createdDate: 'Mar 18, 2026' },
  ...
  { id: 'PL-013', projectId: 7, project: 'Sunset Ridge Apartments', location: 'Building A - Foundation', description: 'Waterproofing membrane tear at footing corner', assignee: 'Foundation Specialists', status: 'in-progress', priority: 'medium', createdDate: 'Mar 24, 2026' },
  ...
  { id: 'PL-015', projectId: 8, project: 'Industrial Park Warehouse', location: 'Zone 2 - Slab', description: 'Vapor barrier puncture at column base plate', assignee: 'Foundation Specialists', status: 'completed', priority: 'medium', createdDate: 'Mar 25, 2026' },
  { id: 'PL-016', projectId: 8, project: 'Industrial Park Warehouse', location: 'Overhead Door 3', description: 'Door frame anchor bolt spacing out of tolerance', assignee: 'Summit HVAC', status: 'open', priority: 'low', createdDate: 'Mar 26, 2026' },
];
