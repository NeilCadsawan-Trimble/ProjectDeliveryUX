...
export const RFIS: Rfi[] = [
  ...
  { id: '11', number: 'RFI-011', subject: 'DNS cutover sequencing', question: 'What is the proposed DNS cutover sequence for migrating production traffic to the new cloud endpoints, and what TTL values should be set during the transition window?', askedBy: 'Daniel Park', askedOn: 'Mar 10, 2026', project: 'Cloud Infrastructure Migration', assignee: 'Tom Evans', status: 'upcoming', dueDate: 'Mar 25, 2026' },
  { id: '12', number: 'RFI-012', subject: 'Network segmentation requirements', question: 'Should the migrated workloads use dedicated VPCs per environment or a shared VPC with subnet-level isolation, and what firewall rules are required between tiers?', askedBy: 'Chris Delgado', askedOn: 'Mar 14, 2026', project: 'Cloud Infrastructure Migration', assignee: 'Sarah Chen', status: 'open', dueDate: 'Mar 28, 2026' },
  { id: '13', number: 'RFI-013', subject: 'Disaster recovery RTO/RPO targets', question: 'What are the approved recovery time objective and recovery point objective targets for tier-1 services after migration, and does the DR plan require cross-region replication?', askedBy: 'Angela Torres', askedOn: 'Feb 20, 2026', project: 'Cloud Infrastructure Migration', assignee: 'James Carter', status: 'overdue', dueDate: 'Mar 5, 2026' },
];
